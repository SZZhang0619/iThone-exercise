...
describe('AppComponent', () => {
  ...
  describe('Integration testing', () => {
    ...
    describe('Account input field', () => {
      ...
      it('should have attribute "name" and value is "account"', () => {
        // Arrange
      ...
      it('should trigger function "accountValueChagne" when the value be changed', () => {
        // Arrange
    ...
    describe('Login button', () => {
      ...
      it('should have attributed "type" and the value is "submit"', () => {
        // Arrange
        const attributeName = 'type';
      ...
      describe('When the form\'s status is valid', () => {
        beforeEach(() => {
          component.account = 'abc@gmail.com';
